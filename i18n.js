(() => {
    ...
    const dictionaries = {
        ...
        ko: {
            ...
            'Hyeongjun Kang, Jeonghyeon Kim, Jemin Lee, Donghee Lee, Juyoung Lee, Youngwon Kim · Kumoh National Institute of Technology': '강형준, 김정현, 이제민, 이동희, 이주영, 김영원 · 국립금오공과대학교',
            'Juyoung Lee, Jeonghyeon Kim, Hyeongjun Kang, Jemin Lee, Donghee Lee, Youngwon Kim · Kumoh National Institute of Technology': '이주영, 김정현, 강형준, 이제민, 이동희, 김영원 · 국립금오공과대학교',
            'Donghee Lee, Hyeongjun Kang, Jeonghyeon Kim, Jemin Lee, Juyoung Lee, Youngwon Kim · Kumoh National Institute of Technology': '이동희, 강형준, 김정현, 이제민, 이주영, 김영원 · 국립금오공과대학교',
