(() => {
    ...
    const dictionaries = {
        ...
        ko: {
            ...
            'Our paper "XR Interaction while Lying Down" has been conditionally accepted to IEEE ISMAR 2026 (CS 우수 국제학술대회).': '논문 "XR Interaction while Lying Down"이 IEEE ISMAR 2026(CS 우수 국제학술대회)에 조건부 채택되었습니다.',
            ...
            'Develops high-precision digital-twin technologies to improve manipulation dexterity in multi-agent manufacturing environments.': '다개체 제조환경에서 조작 숙련성을 개선하기 위한 고정밀 디지털트윈 기술을 개발합니다.',
