(() => {
    ...
    const dictionaries = {
        ...
        ko: {
            ...
            'Gave a presentation at 2026 Korea Society of Digital Content Summer Conference and Undergraduate Paper Competition presenting our paper. "Design of a PC-XR Interlinked Spatial Pointing and Device Management System for XR Collaborative Environmentse" by Donghee Lee.': '2026년 한국디지털콘텐츠학회 하계종합학술대회 및 대학생논문경진대회에서 이동희 학생의 논문 "XR 협업 환경을 위한 PC-XR 연동 공간 포인팅 및 디바이스 관리 시스템 설계"를 발표했습니다.',
            ...
            'We have been published in the Journal of the Digital Content with our paper, "Model Refinement Pipeline via Re-observation of 3D Gaussian Splatting-based Digital Twins Using XR Smart Glasses."': '논문 "XR 스마트글래스를 이용한 3D Gaussian Splatting 기반 디지털 트윈의 재관측을 통한 모델 정밀화 파이프라인"이 디지털콘텐츠학회논문지에 게재되었습니다.',
            'We have been accepted to present our paper, "Phonaze: Gaze-Hover with Torso-Supported Phone Confirmation for Ergonomic Interaction in Supine Mixed Reality" (Hyeongjun Kang, Jeonghyeon Kim, Donghee Lee, Jemin Lee, Seungwoo Woo, Byungwoo Cho, Jungsik Koo, Sunyoung Son, Jung-Hoon Ahn, Giwon Ku, and Youngwon Kim), at a top-tier BK21 conference in Computer Science, IEEE ISMAR 2026 (Acceptance Rate: 21.1%).': 'BK21 컴퓨터과학 분야 우수 국제학술대회인 IEEE ISMAR 2026에서 논문 "Phonaze: Gaze-Hover with Torso-Supported Phone Confirmation for Ergonomic Interaction in Supine Mixed Reality"(강형준, 김정현, 이동희, 이제민, 우승우, 조병우, 구정식, 손선영, 안정훈, 구기원, 김영원)를 발표하게 되었습니다(채택률 21.1%).',
            ...
            'We have been published in the Journal of the Digital Content with our paper, "In-XR Spread Interaction-Based Magnifying Display for Users with Reduced Vision."': '논문 "In-XR Spread Interaction-Based Magnifying Display for Users with Reduced Vision"이 디지털콘텐츠학회논문지에 게재되었습니다.',
            'We have been published in the Journal of the Digital Content with our paper, "User\'s Controller and Elbow-Based Calibration Technique for Realistic Avatar Creation in an Extended Reality Environment."': '논문 "User\'s Controller and Elbow-Based Calibration Technique for Realistic Avatar Creation in an Extended Reality Environment"이 디지털콘텐츠학회논문지에 게재되었습니다.',
